...
#define FL_EN           (5*32 + 9) /*GPIO_6_9*/
#define LBATT_INT         (3*32 + 7) /*add for gas_gauge int*/
#define WIFI_EN (3*32 + 5) /*GPIO_4_5*/
//#define WIFI_RST (4*32 + 28) /*GPIO_5_28*/ //EP7
#define WIFI_RST (5*32 + 10) /*GPIO_6_10*/	//EP7A
...
static iomux_v3_cfg_t mx50_rdp[] = {
	...
	//MX50_PAD_SD1_EN__GPIO_4_2,/*EP7*/
	MX50_PAD_DISP_D8__GPIO_2_8, /*EP7A&EP8*/
	/* SD2 */
	...
	MX50_PAD_SSI_TXC__SSI_TXC,
	MX50_PAD_SSI_TXFS__SSI_TXFS,
	MX50_PAD_ECSPI1_SS0__GPIO_4_15, /* HP_DET_B (headphone auto detect pin) */
	MX50_PAD_OWIRE__CCM_SSI_EXT1_CLK, /* MCLK */
	MX50_PAD_KEY_COL0__GPIO_4_0, /* Connect KEY_COL0/GP4_0 RSDn */
	 ...
	 */
	//MX50_PAD_OWIRE__USBH1_OC,//confuse with AUDIO_CLK
	...
	/*Gas Gauge driver*/
	MX50_PAD_KEY_ROW3__GPIO_4_7,	/*add for gas gauge irq*/
};
...
static iomux_v3_cfg_t mx50_rd3_adjust[] = {
	...
	MX50_PAD_UART1_RTS__GPIO_6_9,	/* Front Light EN  */
...
static iomux_v3_cfg_t suspend_enter_pads[] = {
	...
	//MX50_PAD_SD3_WP__GPIO_5_28,//EP7 wifi reset pin
...
static struct regulator_init_data fp9928_init_data[] = {
	{
		...
		.constraints = {
			.name = "VCOM",
			.min_uV = mV_to_uV(-4000),	//for ep7a panel ED060XH2
			.max_uV = mV_to_uV(-300),	
			.valid_ops_mask = REGULATOR_CHANGE_VOLTAGE |
			REGULATOR_CHANGE_STATUS,
		},
...
static unsigned int sdhc_get_card_det_status(struct device *dev)
{
	...
	if (to_platform_device(dev)->id == 0) {
		...
		if(ret == 0) {
			...
			mxc_iomux_v3_setup_pad(MX50_PAD_DISP_D8__GPIO_2_8);//EP7A
			gpio_request(SD1_EN, "sdhc1-en");
...
#endif //sgtl5000 audio codec

//Add ssm2602 audio codec settings.
...
static struct platform_pwm_backlight_data mxc_pwm_backlight_data = {
	.pwm_id = 0,
	.max_brightness = 320,
	.dft_brightness = 320,	//320 scales
	.pwm_period_ns = 10000000,//100Hz, 32000/100=320
};
