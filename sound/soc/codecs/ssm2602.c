...
static int ssm2602_mute(struct snd_soc_dai *dai, int mute)
{
	...
	printk("%s:mute=%d, open=%d, mute_reg=0x%x\n", __func__, mute, open, mute_reg);
	if (mute){
		if(0 == open)
		{
			gpio_request(RSDn, "RSD");
			gpio_set_value(RSDn, 0);
			msleep(10);
...
static int ssm2602_init(struct snd_soc_device *socdev)
{
	...
	ssm2602_write(codec, SSM2602_LOUT1V, 0x176); //// LHPVOL[6:0]=1110110 -3dB default 0x179 1111001 0dB
	//printk("0x02=0x%x\n", ssm2602_read_reg_cache(codec, SSM2602_LOUT1V));
	//reg = ssm2602_read_reg_cache(codec, SSM2602_ROUT1V);
	//ssm2602_write(codec, SSM2602_ROUT1V, reg | ROUT1V_RLHP_BOTH);
	ssm2602_write(codec, SSM2602_ROUT1V, 0x176);
	//printk("0x03=0x%x\n", ssm2602_read_reg_cache(codec, SSM2602_ROUT1V));
